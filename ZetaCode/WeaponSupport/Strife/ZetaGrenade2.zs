class ZetaGrenade2 : ZetaWeapon
{
	...
	{
		return other.GetClass() == "StrifeGrenadeLauncher2";
	}
	...
	{
		HEGrenade gr = HEGrenade(shooter.SpawnMissileAngle("PhosphorousGrenade", shooter.angle + ZetaWeapon.RandomAngle(11 - shooter.accuracy / 10), tan(shooter.pitch + ZetaWeapon.RandomAngle(11 - shooter.accuracy / 10))));
